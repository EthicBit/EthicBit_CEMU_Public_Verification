#!/usr/bin/env python3
"""
Anchor v4.0 controlled evidence on Sepolia — EIP-4844 type-3 KZG blob TX.
...
Output: assurance/v4_0/V4_0_CONTROLLED_EVIDENCE_ANCHOR_RECEIPT.json
...
RECEIPT_OUT = ROOT / "assurance/v4_0/V4_0_CONTROLLED_EVIDENCE_ANCHOR_RECEIPT.json"
...
def build_payload() -> dict:
    ...
    return {
        "schema":                    "ETHICBIT_AEM_V4_0_CONTROLLED_EVIDENCE_SEPOLIA_ANCHOR_V1",
        ...
        "non_claim": (
            ...
            "Timestamped integrity reference for v4.0 controlled evidence execution. "
            "Does not claim v4.0 validated, third-party reproduced, or production-ready. "
            "5/8 criteria remain PENDING_EXTERNAL."
        ),
    }
...
def main():
    print("=" * 64)
    print("EthicBit / AEM-EVOLVE v4.0 Controlled Evidence Sepolia Anchor")
    print("=" * 64)
    ...
    anchor_receipt = {
        "schema_id":             "ETHICBIT_AEM_V4_0_CONTROLLED_EVIDENCE_SEPOLIA_ANCHOR_V1",
    ...
    print(f"  schema        : ETHICBIT_AEM_V4_0_CONTROLLED_EVIDENCE_SEPOLIA_ANCHOR_V1")
    print(f"  git_commit    : {payload_dict['git_commit_sha'][:16]}...")
