#!/usr/bin/env python3
"""Full-stack independent reproduction verifier — AEM-EVOLVE™ v1.7.

Runs all v1.1–v1.7 verification scripts end-to-end.

Requirements: Python >= 3.11, cryptography, mlkem, asyncpg, fastapi, langgraph, starlette, httpx

Output: FULL_STACK_VERIFICATION=PASS (21/21) | FAIL
"""
...
V1_7       = REPO_ROOT / "assurance/evolve-multi-agent/v1_7"
REPORT_OUT = V1_7 / "REPRODUCTION_REPORT.json"
...
def main() -> int:
    print("AEM-EVOLVE™ v1.7 Full-Stack Verification")
    print("=" * 52)
    results = []
    passed = 0
    total = len(CHECKS)
    ...
    v17 = sum(1 for r in results[18:]   if r["result"] == "PASS")
    print(f"  v1.1: {v11}/6  ·  v1.2: {v12}/2  ·  v1.3: {v13}/4  ·  v1.4: {v14}/2  ·  v1.5: {v15}/2  ·  v1.6: {v16}/2  ·  v1.7: {v17}/3")
    ...
    V1_7.mkdir(parents=True, exist_ok=True)
