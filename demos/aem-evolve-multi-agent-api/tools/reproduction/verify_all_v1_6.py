#!/usr/bin/env python3
"""Full-stack independent reproduction verifier — AEM-EVOLVE™ v1.6.

Runs all v1.1–v1.6 verification scripts end-to-end.

Requirements: Python >= 3.11, cryptography, mlkem, asyncpg, fastapi, langgraph, starlette, httpx

Output: FULL_STACK_VERIFICATION=PASS (18/18) | FAIL
"""
...
V1_6       = REPO_ROOT / "assurance/evolve-multi-agent/v1_6"
REPORT_OUT = V1_6 / "REPRODUCTION_REPORT.json"
...
def main() -> int:
    print("AEM-EVOLVE™ v1.6 Full-Stack Verification")
    print("=" * 52)
    results = []
    passed = 0
    total = len(CHECKS)
    ...
    v16 = sum(1 for r in results[16:]  if r["result"] == "PASS")
    print(f"  v1.1: {v11}/6  ·  v1.2: {v12}/2  ·  v1.3: {v13}/4  ·  v1.4: {v14}/2  ·  v1.5: {v15}/2  ·  v1.6: {v16}/2")
    ...
    report = {
        ...
        "non_claims": [
            ...
            "Ephemeral signing key is not persisted across restarts.",
    ...
    V1_6.mkdir(parents=True, exist_ok=True)
