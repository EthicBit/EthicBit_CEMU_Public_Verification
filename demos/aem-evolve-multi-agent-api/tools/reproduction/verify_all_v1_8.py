#!/usr/bin/env python3
"""Full-stack independent reproduction verifier — AEM-EVOLVE™ v1.8.

Runs all v1.1–v1.8 verification scripts end-to-end.

Requirements: Python >= 3.11, cryptography, mlkem, asyncpg, fastapi, langgraph, starlette, httpx

Output: FULL_STACK_VERIFICATION=PASS (24/24) | FAIL
"""
...
V1_8       = REPO_ROOT / "assurance/evolve-multi-agent/v1_8"
REPORT_OUT = V1_8 / "REPRODUCTION_REPORT.json"
...
CHECKS = [
    ...
    {"check_id": "V1_8-PYTEST-SUITE",
     "script": None,  # run pytest directly
...
def main() -> int:
    print("AEM-EVOLVE™ v1.8 Full-Stack Verification")
    print("=" * 52)
    results = []
    passed = 0
    total = len(CHECKS)
    ...
    v18 = sum(1 for r in results[21:]   if r["result"] == "PASS")
    print(f"  v1.1: {v11}/6  ·  v1.2: {v12}/2  ·  v1.3: {v13}/4  ·  v1.4: {v14}/2  ·  v1.5: {v15}/2  ·  v1.6: {v16}/2  ·  v1.7: {v17}/3  ·  v1.8: {v18}/3")
    ...
    report = {
        ...
        "non_claims": [
            ...
            "PostgreSQL path verified at env-var logic level only — no live DB required.",
    ...
    V1_8.mkdir(parents=True, exist_ok=True)
