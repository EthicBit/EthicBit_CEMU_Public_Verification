...
**Generated UTC:** `2026-05-17T20:12:37.622195+00:00`
**Commit:** `81ffecfe`
...
|---|---:|---:|---|
| `claim_red_team_overclaim_blocking` | `PASS` | 100 | Blocked 10/10 attempted overclaims; external claim review remains false. |
...
| `release_packaging_secret_leak_abuse_scan` | `PASS` | 100 | Scanned 1490 tracked files and 9 release ZIPs for sensitive entries. |
